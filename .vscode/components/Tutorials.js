  ...
  return (
    <div>
      ...
      <Grid container columnSpacing={1} rowSpacing={1} className="containerGrid">
        ...
        <CardOfCourse CourseName="classNameification" CourseDuration="5" CourseLessons="40" />
        ...
        <CardOfCourse CourseName="Multi className classNameification" CourseDuration="1" CourseLessons="15" />
      </Grid>
    </div>
  )
}
